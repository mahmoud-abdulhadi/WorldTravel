...
namespace WorldTravel.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if(await _userManager.FindByEmailAsync("bruce.wayn@gmail.com") == null)
            {
            ...
            if(await _userManager.FindByEmailAsync("clark.kent@gmail.com") == null)
            {
